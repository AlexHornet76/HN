...
GRANT ALL PRIVILEGES ON handballnow.* TO '<your_user>'@'localhost';

CREATE USER '<your_user>'@'127.0.0.1' IDENTIFIED BY '<your_pass>';
GRANT ALL PRIVILEGES ON handballnow.* TO '<your_user>'@'127.0.0.1';
