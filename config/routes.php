<?php
    $routes = [
        ...
        "HN/contact" => ["ContactController", "index"],
        "HN/sendEmail" => ["ContactController", "send"],
        "HN/exportRankings" => ["TeamsController", "export"],
        "HN/uploadExcel" => ["PlayersController", "uploadExcel"],
        "HN/archive" => ["TeamsController", "archive"],
    ];
